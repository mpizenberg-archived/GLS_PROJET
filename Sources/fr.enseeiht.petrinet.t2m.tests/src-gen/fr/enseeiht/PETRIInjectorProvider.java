...
public class PETRIInjectorProvider implements IInjectorProvider, IRegistryConfigurator {
	...
	public Injector getInjector() {
		if (injector == null) {
			this.injector = new PETRIStandaloneSetup().createInjectorAndDoEMFRegistration();
		}
		return injector;
	}
