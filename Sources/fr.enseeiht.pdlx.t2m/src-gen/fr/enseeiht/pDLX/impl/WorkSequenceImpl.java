 ...
 * <ul>
 *   <li>{@link fr.enseeiht.pDLX.impl.WorkSequenceImpl#getLinkType <em>Link Type</em>}</li>
 *   <li>{@link fr.enseeiht.pDLX.impl.WorkSequenceImpl#getPredecessor <em>Predecessor</em>}</li>
 *   <li>{@link fr.enseeiht.pDLX.impl.WorkSequenceImpl#getSuccessor <em>Successor</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class WorkSequenceImpl extends ProcessElementImpl implements WorkSequence
{
  ...
  {
    return PDLXPackage.Literals.WORK_SEQUENCE;
  }
  ...
  public void setLinkType(WorkSequenceType newLinkType)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PDLXPackage.WORK_SEQUENCE__LINK_TYPE, oldLinkType, linkType));
  }
  ...
  public WorkDefinition getPredecessor()
  {
    if (predecessor != null && predecessor.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, PDLXPackage.WORK_SEQUENCE__PREDECESSOR, oldPredecessor, predecessor));
      }
    }
    return predecessor;
  }
  ...
  public void setPredecessor(WorkDefinition newPredecessor)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PDLXPackage.WORK_SEQUENCE__PREDECESSOR, oldPredecessor, predecessor));
  }
  ...
  public WorkDefinition getSuccessor()
  {
    if (successor != null && successor.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, PDLXPackage.WORK_SEQUENCE__SUCCESSOR, oldSuccessor, successor));
      }
    }
    return successor;
  }
  ...
  public void setSuccessor(WorkDefinition newSuccessor)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PDLXPackage.WORK_SEQUENCE__SUCCESSOR, oldSuccessor, successor));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case PDLXPackage.WORK_SEQUENCE__LINK_TYPE:
        return getLinkType();
      case PDLXPackage.WORK_SEQUENCE__PREDECESSOR:
        if (resolve) return getPredecessor();
        return basicGetPredecessor();
      case PDLXPackage.WORK_SEQUENCE__SUCCESSOR:
