 ...
 * @generated
 */
public class PDLXPackageImpl extends EPackageImpl implements PDLXPackage
{
  /**
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  private EClass needSetEClass = null;
   ...
   * @see fr.enseeiht.pDLX.PDLXPackage#eNS_URI
   * @see #init()
   * @generated
   */
  private PDLXPackageImpl()
  {
    super(eNS_URI, PDLXFactory.eINSTANCE);
  }
   ...
   * 
   * <p>This method is used to initialize {@link PDLXPackage#eINSTANCE} when that field is accessed.
   ...
   * @generated
   */
  public static PDLXPackage init()
  {
    if (isInited) return (PDLXPackage)EPackage.Registry.INSTANCE.getEPackage(PDLXPackage.eNS_URI);

    // Obtain or create and register package
    PDLXPackageImpl thePDLXPackage = (PDLXPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof PDLXPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new PDLXPackageImpl());

    isInited = true;

    // Create package meta-data objects
    thePDLXPackage.createPackageContents();

    // Initialize created meta-data
    thePDLXPackage.initializePackageContents();

    // Mark meta-data to indicate it can't be changed
    thePDLXPackage.freeze();

  
    // Update the registry and return the package
    EPackage.Registry.INSTANCE.put(PDLXPackage.eNS_URI, thePDLXPackage);
    return thePDLXPackage;
  }
   ...
   * @generated
   */
  public EAttribute getNeed_Quantity()
  {
   ...
   * @generated
   */
  public EReference getNeed_NeedSet()
  {
   ...
   * @generated
   */
  public EClass getNeedSet()
  {
    return needSetEClass;
  }
   ...
   * @generated
   */
  public EAttribute getNeedSet_Name()
  {
    return (EAttribute)needSetEClass.getEStructuralFeatures().get(0);
  }
   ...
   * @generated
   */
  public EReference getNeedSet_Wd()
  {
    return (EReference)needSetEClass.getEStructuralFeatures().get(1);
  }
   ...
   * @generated
   */
  public PDLXFactory getPDLXFactory()
  {
    return (PDLXFactory)getEFactoryInstance();
  }
  ...
  public void createPackageContents()
  {
    ...
    createEAttribute(needEClass, NEED__QUANTITY);
    createEReference(needEClass, NEED__NEED_SET);

    needSetEClass = createEClass(NEED_SET);
    createEAttribute(needSetEClass, NEED_SET__NAME);
    createEReference(needSetEClass, NEED_SET__WD);
  ...
  public void initializePackageContents()
  {
    ...
    needSetEClass.getESuperTypes().add(this.getProcessElement());
    ...
    initEClass(processEClass, fr.enseeiht.pDLX.Process.class, "Process", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getProcess_Name(), ecorePackage.getEString(), "name", null, 0, 1, fr.enseeiht.pDLX.Process.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getProcess_ProcessElements(), this.getProcessElement(), null, "processElements", null, 0, -1, fr.enseeiht.pDLX.Process.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEAttribute(getNeed_Quantity(), ecorePackage.getEInt(), "quantity", null, 0, 1, Need.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getNeed_NeedSet(), this.getNeedSet(), null, "needSet", null, 0, 1, Need.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(needSetEClass, NeedSet.class, "NeedSet", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getNeedSet_Name(), ecorePackage.getEString(), "name", null, 0, 1, NeedSet.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getNeedSet_Wd(), this.getWorkDefinition(), null, "wd", null, 0, 1, NeedSet.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
