...
import fr.enseeiht.pETRI.PetriNetElement;
 ...
 * <ul>
 *   <li>{@link fr.enseeiht.pETRI.impl.PetriNetImpl#getName <em>Name</em>}</li>
 *   <li>{@link fr.enseeiht.pETRI.impl.PetriNetImpl#getPetriNetElements <em>Petri Net Elements</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PetriNetImpl extends MinimalEObjectImpl.Container implements PetriNet
{
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PETRIPackage.PETRI_NET__NAME, oldName, name));
  }
  ...
  public EList<PetriNetElement> getPetriNetElements()
  {
    ...
    {
      petriNetElements = new EObjectContainmentEList<PetriNetElement>(PetriNetElement.class, this, PETRIPackage.PETRI_NET__PETRI_NET_ELEMENTS);
    }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case PETRIPackage.PETRI_NET__PETRI_NET_ELEMENTS:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case PETRIPackage.PETRI_NET__NAME:
        return getName();
      case PETRIPackage.PETRI_NET__PETRI_NET_ELEMENTS:
