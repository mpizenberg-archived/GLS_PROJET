 ...
 * <ul>
 *   <li>{@link fr.enseeiht.pETRI.impl.PlaceImpl#getMarking <em>Marking</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PlaceImpl extends NodeImpl implements Place
{
  ...
  public void setMarking(int newMarking)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PETRIPackage.PLACE__MARKING, oldMarking, marking));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case PETRIPackage.PLACE__MARKING:
        return getMarking();
    }
