 ...
 * <ul>
 *   <li>{@link fr.enseeiht.pETRI.Place#getMarking <em>Marking</em>}</li>
 * </ul>
 * </p>
 *
 * @see fr.enseeiht.pETRI.PETRIPackage#getPlace()
 * @model
 * @generated
 */
public interface Place extends Node
{
   ...
   * @see #setMarking(int)
   * @see fr.enseeiht.pETRI.PETRIPackage#getPlace_Marking()
   * @model
   * @generated
   */
  int getMarking();
  ...
  /**
   * Sets the value of the '{@link fr.enseeiht.pETRI.Place#getMarking <em>Marking</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
