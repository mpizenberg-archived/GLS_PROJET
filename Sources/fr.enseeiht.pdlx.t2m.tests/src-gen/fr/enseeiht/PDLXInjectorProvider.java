...
public class PDLXInjectorProvider implements IInjectorProvider, IRegistryConfigurator {
	...
	public Injector getInjector() {
		if (injector == null) {
			this.injector = new PDLXStandaloneSetup().createInjectorAndDoEMFRegistration();
		}
		return injector;
	}
